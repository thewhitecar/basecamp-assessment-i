...
var responseCreator = function(param){
  if (param == "green"){return colorResponse = "Green is okay"}
  else if (param == "red"){return colorResponse = "I heart red"}
